"""Module to handle human players
"""
import re
...
class ConsolePlayer(Player):
    """Class to handle instantiation of human players
...
def grid_to_index(grid: str) -> int:
    """Public method to handle game coordinates. Input must be in format A1 or 1A.
    Letters can be A, B or C, and number 1, 2, or 3

    Args:
        grid (str): Human input
